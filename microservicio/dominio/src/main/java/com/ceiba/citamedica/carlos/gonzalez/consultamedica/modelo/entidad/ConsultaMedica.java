...
public class ConsultaMedica {
    private final  Mensage SE_DEBE_INGRESAR_INFORMACION_ESPECILISTA = Mensage.MENSAGE_INFORMACION_ESPECIALISTA_REQUERIDO;
    private final  Mensage SE_DEBE_INGRESAR_INFORMACION_PACIENTE = Mensage.MENSAGE_INFORMACION_PACIENTE_REQUERIDO;;
    private final  Mensage SE_DEBE_INGRESAR_LA_FECHA_CITA  = Mensage.MENSAGE_FECHA_CITA__REQUERIDO;
    private final  Mensage SE_DEBE_INGRESAR_EL_TIPO_USUARIO  = Mensage.MENSAGE_TIPO_USUARIO_REQUERIDO;
